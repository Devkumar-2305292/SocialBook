        ...
        <div>
          <div className="bg-white dark:bg-[#262829] p-6 rounded-lg shadow-md md:W-[450px]">
            <form onSubmit={handleSubmit} className="flex flex-col space-y-3">
              ...
              <button
                type="submit"
                className="bg-blue-600 text-white text-xl font-bold py-3 rounded-lg hover:bg-blue-700 transition"
              >
                Log in
              </button>

              <Link className="text-blue-600 text-sm text-center hover:underline">
                Forgotten Password
              </Link>
              <hr className="mb-7 mt-2 text-gray-200" />
              <Link
                to="/signup"
                className="bg-green-500 text-lg text-white font-semibold py-3 rounded-lg hover:bg-green-700 transition w-fit mx-auto px-6"
              >
                Create new account
              </Link>
            </form>
          </div>
          <p className="text-md text-center mt-7 tracking-tight ">
