...
const Signup = () => {
  ...
  return (
    <div className="h-screen flex flex-col gap-7 items-center justify-center py-10">
      ...
      <div className="bg-white dark:bg-[#262829] p-3 rounded-lg shadow-md w-full md:max-w-112.5 mx-1 md:mx-0">
        ...
        >
          ...
          <p className="text-xs text-gray-600 mt-2">
            ...
            <Link className="text-blue-800 hover:underline">Learn more</Link>
          </p>
          <p className="text-xs text-gray-600 mt-1">
            By clicking Sign up, you agree to our{" "}
            <Link className="text-blue-800 hover:underline">Terms</Link>{" "}
            ...
            You may receive SMS notifications form us and can opt out at any
            time.
          </p>
          <button
            type="submit"
            className="bg-green-600 text-white text-lg font-bold py-2 px-7 w-[200px] rounded"
          >
            Sign up
          </button>
          <Link to={"/login"}>
            <p className="text-blue-600 hover:text-blue-700 text-lg my-2 cursor-pointer">
